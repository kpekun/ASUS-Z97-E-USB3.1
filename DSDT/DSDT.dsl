 ...
 *
 * Disassembly of C:/Users/Korhan/Desktop/DSDT.aml, Sat Apr 18 16:07:15 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000F5A6 (62886)
 *     Revision         0x02
 *     Checksum         0xB8
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000011)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDDA97A98, 0x034D)
            ...
            Device (LPCB)
            {
                ...
                Device (SIO1)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y20._MIN, GPI0)  // _MIN: Minimum Base Address
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y20._MAX, GPI1)  // _MAX: Maximum Base Address
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y20._LEN, GPIL)  // _LEN: Length
                            GPI0 = SP1O /* \SP1O */
                            GPI1 = SP1O /* \SP1O */
                            GPIL = 0x02
                        }
                        ...
                        If (IO1B)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y21._MIN, GP10)  // _MIN: Minimum Base Address
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y21._MAX, GP11)  // _MAX: Maximum Base Address
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y21._LEN, GPL1)  // _LEN: Length
                            GP10 = IO1B /* \IO1B */
                            GP11 = IO1B /* \IO1B */
                            GPL1 = IO1L /* \IO1L */
                        }
                        ...
                        If (IO2B)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y22._MIN, GP20)  // _MIN: Minimum Base Address
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y22._MAX, GP21)  // _MAX: Maximum Base Address
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y22._LEN, GPL2)  // _LEN: Length
                            GP20 = IO2B /* \IO2B */
                            GP21 = IO2B /* \IO2B */
                            GPL2 = IO2L /* \IO2L */
                        }
                        ...
                        If (IO3B)
                        {
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y23._MIN, GP30)  // _MIN: Minimum Base Address
                            CreateWordField (CRS, \_SB.PCI0.LPCB.SIO1._Y23._MAX, GP31)  // _MAX: Maximum Base Address
                            CreateByteField (CRS, \_SB.PCI0.LPCB.SIO1._Y23._LEN, GPL3)  // _LEN: Length
                            GP30 = IO3B /* \IO3B */
                            GP31 = IO3B /* \IO3B */
                            GPL3 = IO3L /* \IO3L */
                        }
                ...
                {
                    ^SIO1.ENFG (0x09)
                    Local0 = ^SIO1.OPT5 /* \_SB_.PCI0.LPCB.SIO1.OPT5 */
                    If ((Arg0 == Zero))
                    {
                        Local0 &= 0xFE
                        ^SIO1.OPT5 = Local0
                ...
                Scope (^^PCI0)
                {
                    ...
                    {
                        "937308352451Genuine NVIDIA Certified SLI Ready Motherboard for ASUS BLACK          e963-Copyright 2014 NVIDIA Corporation All Rights Reserved-950249559801(R)"
                    })
                    Device (WMI1)
                    {
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDD83EE98, 0x10)
    ...
    Scope (_GPE)
    {
        ...
        Name (RG3H, Zero)
        Name (RG4H, Zero)
        OperationRegion (GPBX, SystemIO, GPBA, 0x80)
        ...
        {
            \_SB.PCI0.LPCB.SIO1.ENFG (Zero)
            \_SB.PCI0.LPCB.SIO1.SCF8 &= 0xEF
            Stall (0x32)
            BANK &= 0xF0
            BANK |= 0x04
            Local0 = (RE91 & 0xFF)
            ...
            BANK &= 0xF0
            BANK |= Zero
            Local0 = RE41 /* \_GPE.RE41 */
            Sleep (0x03E8)
            \_SB.PCI0.LPCB.SIO1.SCF8 |= 0x10
